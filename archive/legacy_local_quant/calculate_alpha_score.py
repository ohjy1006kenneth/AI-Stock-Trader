...
from runtime.common.common import MARKET_DATA_DIR, STRATEGY_DATA_DIR, now_iso, read_json, realized_volatility, rsi, sma, trailing_return, write_json
...
def main() -> None:
    ...
    qualified = read_json(STRATEGY_DATA_DIR / "qualified_universe.json", {"items": []})
    ...
    write_json(STRATEGY_DATA_DIR / "alpha_rankings.json", {
