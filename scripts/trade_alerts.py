...
from common import DATA_DIR, LEDGER_DIR, OUTPUTS_DIR, now_iso, read_json, write_json, write_text

STATE_PATH = DATA_DIR / "alert_state.json"
ALERT_REPORT_PATH = OUTPUTS_DIR / "trade_alerts_latest.json"
ALERT_TEXT_PATH = OUTPUTS_DIR / "trade_alerts_latest.txt"
